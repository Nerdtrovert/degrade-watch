...
from scripts.analyze_baselines import load_merchant_profile, parse_timestamp, categorize_failure, calculate_statistics, calculate_percentiles
...
def main():
    ...
    for k, v in current_stats.items():
        if k != "overall":  # Don't print the whole overall dict here, we'll print it separately
            print(f"  {k}: {v}")
    ...
    print(json.dumps(current_stats.get("overall", {}), indent=2))
