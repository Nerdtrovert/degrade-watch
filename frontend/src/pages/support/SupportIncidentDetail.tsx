  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Success Rate Evidence</h2>
          {incident.success_rate_evidence ? (
            <div className="space-y-3">
              ...
              <p><strong>Absolute Change:</strong> {(incident.success_rate_evidence.absolute_change || 0) * 100}% points</p>
              <p><strong>Relative Change:</strong> {(incident.success_rate_evidence.relative_change || 0) * 100}%</p>
              ...
              {incident.success_rate_evidence.statistical_significance ? (
                <div className="bg-gray-50 p-3 rounded">
                  ...
                  <p>Confidence Level: {incident.success_rate_evidence.statistical_significance.confidence_level * 100}%</p>
        ...
        {/* Error Evidence */}
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Error Evidence</h2>
          {incident.error_evidence ? (
            <div className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h3 className="text-lg font-bold mb-2">Baseline</h3>
                  <p><strong>Customer Error Rate:</strong> {(incident.error_evidence.baseline.customer_error_rate || 0) * 100}%</p>
                  <p><strong>Technical Error Rate:</strong> {(incident.error_evidence.baseline.technical_error_rate || 0) * 100}%</p>
                  <p><strong>Other Error Rate:</strong> {(incident.error_evidence.baseline.other_error_rate || 0) * 100}%</p>
                  <p><strong>Failure Rate:</strong> {(incident.error_evidence.baseline.failure_rate || 0) * 100}%</p>
                ...
                <div>
                  <h3 className="text-lg font-bold mb-2">Current</h3>
                  <p><strong>Customer Error Rate:</strong> {(incident.error_evidence.current.customer_error_rate || 0) * 100}%</p>
                  <p><strong>Technical Error Rate:</strong> {(incident.error_evidence.current.technical_error_rate || 0) * 100}%</p>
                  <p><strong>Other Error Rate:</strong> {(incident.error_evidence.current.other_error_rate || 0) * 100}%</p>
                  <p><strong>Failure Rate:</strong> {(incident.error_evidence.current.failure_rate || 0) * 100}%</p>
                  <p><strong>Failure Breakdown:</strong></p>
                  <ul className="list-disc list-inside space-y-1">
              ...
              <div className="mt-4">
                <h3 className="text-lg font-bold mb-2">Changes</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p><strong>Customer Error Rate Change:</strong> {(incident.error_evidence.changes.customer_error_rate_change || 0) * 100}% points</p>
                    <p><strong>Technical Error Rate Change:</strong> {(incident.error_evidence.changes.technical_error_rate_change || 0) * 100}% points</p>
                    <p><strong>Other Error Rate Change:</strong> {(incident.error_evidence.changes.other_error_rate_change || 0) * 100}% points</p>
                    <p><strong>Customer Error Relative Change:</strong> {(incident.error_evidence.changes.customer_error_relative_change || 0) * 100}%</p>
                    <p><strong>Technical Error Relative Change:</strong> {(incident.error_evidence.changes.technical_error_relative_change || 0) * 100}%</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold mb-2">Error Code Distribution</h3>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Localization Evidence</h2>
            ...
            <div className="space-y-3">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Success Rate: {(incident.localization_evidence.affected_segment.success_rate || 0) * 100}%</li>
                    ...
                    {Object.entries(incident.localization_evidence.control_analysis.control_segments || {}).map(([segmentName, segmentData]: [string, any]) => (
                      <li key={segmentName} className="mb-2">
                        ...
                        <ul className="list-disc list-inside pl-4 space-y-1">
                          ...
                          <li>Success Rate: {(segmentData.success_rate || 0) * 100}%</li>
        ...
        {/* Impact Evidence */}
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Impact Evidence</h2>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Investigation Checklist</h2>
        ...
        {/* Sample Payments */}
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-xl font-bold mb-2">Sample Payment Evidence</h2>
