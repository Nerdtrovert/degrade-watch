#!/usr/bin/env python3
"""
Debug script to see what's happening in Recovery Engine initialization.
"""
...
if recovery_engine.razorpay_client is None:
    print("Checking why client wasn't initialized...")
    # Check the conditions from the Recovery Engine code
    ...
    if key_id and key_secret:
        print("Both credentials present, trying to create client...")
        try:
        ...
        print("Missing credentials - this would cause simulation mode")